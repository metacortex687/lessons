...
# Вычислительная сложность: O(n*m*m) где n колличество узлов, а m - некоторое усредненное колличество связей у одного узла
...
# через GetAdjacentVertexIndices. И уже для этих индексов за O(n^2/2) - где n - колличество этих вершин, 
