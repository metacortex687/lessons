...
# Решение:
# Рекурсивно ищу минимальный элемент в листьях. Индексы листьев определяю по индексу последнего узла. 
...
# Решение:
# Забираю последний элемент из кучи источника методом "GetLast" и добавляю в кучу приемник  с помощью метода "Add".
