...
# Для получения итоговой выборки делается n операций, при этом она использует для расчета последовательности n-1, n-2,.. , 1 
# Получается сумма арифметической прогрессии, то есть квадрат.

# Алгоритмическая сложность: ~ O(n^2), где n — количество последовательностей в итоговой выборке.
