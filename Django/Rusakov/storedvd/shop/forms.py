...
class OrderModelForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {'adress': 'Полный адрес (Страна, город, индекс, улица, дом, квартира)'}

        widgets = {
            'adress': forms.Textarea(attrs={'cols': 80, 'rows': 6, 'placeholder': 'При самовывозе можно оставить это поле пустым'}),
