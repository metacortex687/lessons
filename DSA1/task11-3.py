# сделал как добавление новго фильтра к текущему
# реализовал через битовую операцию между значениями фильтра, 
# тогда битовая маска будет содержать для всех значений


# Фильтр Блюма, он со 100% вероятностью отвечает на вопрос если значение не помещалось в фильтр. 
# Тоесть ложно отрицательных значений нет.
# При удалении возможно, что удалятся биты от других значений и значит появятся ложно отрицательные срабатывания. 
# Что необходимо избежать. 
# а
