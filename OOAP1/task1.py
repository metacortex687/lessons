...
# а) Убрал сброс статусов команд на *_NILL для команды clear. Иначе надо тогда объяснить, почему, например, статус для push не сбрасывается после операции pop или peek и т.д., а в clear сбрасываем.
